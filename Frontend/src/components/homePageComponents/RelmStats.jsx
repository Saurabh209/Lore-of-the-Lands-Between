        ...
        <div className="   relative  bg-center bg-fixed bg-cover  mx-auto" style={{ backgroundImage: "url('/img/background1.webp')" }}>
            <div className=' relm-stats  p-5 inset-0    ' >
                <div className=' relm-stats-container  '>
                    ...
                    <div className=" grid grid-cols-2 sm:grid-cols-4 gap-3  md:gap-6" style={{
                        ...
                        {gameStats.map((stat, index) => {
                            ...
                            return (
                                <div key={index} className={`    border border-transparent    rounded-lg  hover:scale-103 ${hoveredBorder} transition-all duration-500 hover-scale hover:backdrop-blur-[2px] animate-fade-in`} style={{ animationDelay: `${index * 0.3}s` }}>
                                    <div className="py-4 px-2 text-center sm:px-4">
                                        <div className='  flex justify-center  gap-2  md:flex-col '>
                                            <div className='   flex justify-center items-center'> <IconComponent className="  h-6 w-6 text-amber-400 mx-auto mb-3 transition-all duration-500 sm:h-8 sm:w-8 group-hover:h-10 group-hover:w-10" /></div>
                                            <div className="text-xl   font-bold text-amber-300 mb-1 sm:text-2xl">{stat.value}</div>
                                        </div>
