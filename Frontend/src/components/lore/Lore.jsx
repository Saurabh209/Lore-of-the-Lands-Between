...
They represent the alien nature of divine authority - beings so removed from human understanding that their very form induces revulsion. They embody the uncomfortable truth that cosmic forces care nothing for human comfort or comprehension.`
    ...
    const mysteries = [
        {
            question: "Who orchestrated the Night of Black Knives?",
            answer: "While Ranni was the mastermind, evidence suggests Queen Marika herself may have been complicit, having her own reasons to see Godwyn dead and the Golden Order challenged."
        },
        {
            question: "What is the true nature of the Outer Gods?",
            answer: "The Outer Gods appear to be cosmic entities that exist beyond the physical realm, each representing different fundamental forces or concepts. They compete for influence over the world through mortal vessels."
        },
        {
            question: "Why did Queen Marika shatter the Elden Ring?",
            answer: "Grief over Godwyn's death, rage at the Greater Will's callousness, and perhaps a desire to free herself and her world from the constraints of absolute order."
        },
        {
            question: "What happened to the other Lands Beyond the Fog?",
            answer: "The Lands Between may be just one region in a larger world. The fog that surrounds it suggests other lands exist, but their fate remains unknown."
        }
    ];
                            ...
                            <div key={index} className=" border p-5 cursor-default rounded-lg border-blue-700/50 hover:border-blue-600 backdrop-blur-[2px]   hover:bg-slate-800/90 transition-all duration-300">
                                <div className='mb-8'>
                                    <div className="   flex items-center gap-3 mb-4">
                                        <topic.icon className="h-6 w-6 text-blue-400" />
