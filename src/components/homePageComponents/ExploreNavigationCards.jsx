...
const ExploreNavigationCards = () => {
    ...
    return (
        <div className='exploreNavigationCardMainContainer    '>
            <div className='w-[80%] m-auto' style={{
                ...
                <div className={`    exploreNavigationAllCardContainer   grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6  `}>
                    {exploreNavigationCard.map((item, index) => {
                        ...
                        return (
                            <div key={index} className={`group border border-white/50   ${hoverBorder} hover:scale-103     exploreNavigationSingleCard  `} style={{ animationDelay: `${index * 0.1}s` }}>
                                <div >
