            ...
            <div className='w-[80%] m-auto my-12 z-2' style={{
                ...
                <div className={`    exploreNavigationAllCardContainer   grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6  `}>
                    {exploreNavigationCard.map((item, index) => {
                        ...
                        return (
                            <div key={index} className={`group border border-white/50  bg-[#0f172a73] hover:bg-[#0f172ac2] backdrop-blur-[4px] ${hoverBorder} hover:scale-103     exploreNavigationSingleCard  `} style={{ animationDelay: `${index * 0.1}s` }}>
                                <div >
